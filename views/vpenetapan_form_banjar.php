...
$(document).ready(function () {
    ...
    var banjar = parseInt(<? echo (defined('BPHTB_BANJAR') && BPHTB_BANJAR == TRUE) ? 1 : 0 ;?>);
    if(banjar==1) {
        $('#ketetapan_no, #ketetapan_tgl, #ketetapan_atas_sspd_no, #ketetapan_jatuh_tempo_tgl').removeAttr('disabled'); 
    }
});
