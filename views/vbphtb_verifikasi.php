...
$(document).ready(function() {    
    ...
    var mytoolbar = '<div class="btn-group pull-left">' +
                    '<button id="btn_edit" class="btn" type="button">Proses Verifikasi BPHTB</button>' +
...
<div class="content">
    <div class="container-fluid"> 
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#main_grid"><strong>Verifikasi BPHTB</strong></a></li>
        </ul>
        <?=msg_block();?>
