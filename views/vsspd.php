...
$(document).ready(function() {
    ...
    var mytoolbar = '<div class="btn-group pull-left">' +
                    ...
                    '<button id="btn_print_pmh" type="button" data-value="printed" class="btn btn-info"><i class="icon-print icon-white"></i>&nbsp;Permohonan</button>' +
                    ...
                    '<button id="btn_print_stpd" type="button" data-value="printed" class="btn btn-info"><i class="icon-print icon-white"></i>&nbsp;STPD</button>' +
                    <? endif; ?>
                    '</div>' +
    ...
    $('#btn_print_skpdkb').click(function() {
        if(mID) {
            if(noSSPD.substring(12,14)=='02' || noSSPD.substring(12,14)=='03') {
                var rpt = 'skpdkb';
                var winparams = 'location=1,status=1,scrollbars=1,resizable=no,width='+screen.width+',height='+screen.height+',menubar=no,toolbar=no,fullscreen=no';
                window.open('<?=active_module_url($this->uri->segment(2));?>show_rpt/?'+rpt+'/'+mID, 'Laporan', winparams);
            } else {
    ...
    $('#btn_print_stpd').click(function() {
        if(mID) {
            if(noSSPD.substring(12,14)=='97') {
                var rpt = 'stpd';
                var winparams = 'location=1,status=1,scrollbars=1,resizable=no,width='+screen.width+',height='+screen.height+',menubar=no,toolbar=no,fullscreen=no';
                window.open('<?=active_module_url($this->uri->segment(2));?>show_rpt/?'+rpt+'/'+mID, 'Laporan', winparams);
            } else {
                alert('Ini bukan data Tagihan !');
            }
        } else {
            alert('Silahkan pilih data yang akan diprint');
        }
    ...
    $('#btn_print_pmh').click(function() {
        if(mID) {
            var rpt = 'pmh_penelitian';
            var winparams = 'location=1,status=1,scrollbars=1,resizable=no,width='+screen.width+',height='+screen.height+',menubar=no,toolbar=no,fullscreen=no';
            window.open('<?=active_module_url($this->uri->segment(2));?>show_rpt/?'+rpt+'/'+mID, 'Laporan', winparams);
        } else {
            alert('Silahkan pilih data yang akan diprint');
