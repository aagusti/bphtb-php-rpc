...
class lap_penelitian extends CI_Controller
{
    ...
    function teliti_ok() {
        ...
        $data['judul_lap'] = 'Laporan Register Penelitian SSPD';
        $data['rpt']       = "sspd";
		
		$tglawal  = date('d-m-Y', strtotime('2014-01-01'));
		$tglakhir = date('d-m-Y');
        $data['tglawal']  = $tglawal;
        $data['tglakhir'] = $tglakhir;
		
        $this->load->view('vlap_penelitian', $data);
    }
    ...
    function teliti_no() {
        ...
        $data['apps']      = $this->apps_model->get_active_only();
		$data['current']   = 'penelitian';
        $data['judul_lap'] = 'Laporan Register SSPD yang belum diteliti';
        $data['rpt']       = "sspd_blm";
    ...
    function penetapan() {
        ...
        $data['apps']      = $this->apps_model->get_active_only();
		$data['current']   = 'penelitian';
        $data['judul_lap'] = 'Laporan Register Penetapan';
        $data['rpt']       = "sspd_penetapan";
